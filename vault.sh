...
VAULT_TOKEN='OUR_VAULT_TOKEN_HERE'       # Update with your Vault token
SECRET_PATH='secret/backend'      # Update with your secret path
ENV_FILE='/home/saleh/Desktop/FinalProject/travel-jo-main/.env'                      # Name of the .env file# Export Vault address and token
export VAULT_ADDR
export VAULT_TOKEN
